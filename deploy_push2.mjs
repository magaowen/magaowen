...
const files = [ "functions/api/[[path]].js" ];
...
const newCommit=await gh("POST",`/repos/${REPO}/git/commits`,{message:"fix: KV 绑定名兼容 SOFTWARE_HUB_KV / MY_KV",tree:newTree.sha,parents:[baseSha]});
